...
parser.add_argument('--dataset_path', default='H:\\Fyf\\data\\Frappe_x1\\frappe_whole.csv')
...
parser.add_argument('--stacked_num', type=int, default=6, help="stacked_gate_layer")
parser.add_argument('--concat_mlp', type=bool, default=False, help="use concat_mlp")
